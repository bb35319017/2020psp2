...
l.26:fnameで指定したファイルの先頭アドレスをファイルポインタfpに読み込む

l.27:もしfpがNULLだったときは、ファイルを開けなかったので，即座にプログラム終了

l.34:ファイルを1行ずつbufに読み込み、読み込み成功する限り繰り返す

l.35:bufからscanfで数値文字列を実数としてvalに読み込む

l.39:square_aveを定義

l.41:aveにave_onlineの戻り値を格納

l.43:varにvar_onlineの戻り値を格納
...
l.39のsquare_aveにonline_aveを流用

l.49-l.53を追加。母集団の値を計算した。